	...
	var MessageHandler = function () {
	  ...
	  _createClass(MessageHandler, [{
	    ...
	    value: function _loadOlm(path) {
	      var _this = this;
	      return this._toMessage( _asyncToGenerator( regeneratorRuntime.mark(function _callee() {
	        var olm;
	    ...
	    key: "_handleMessage",
	    value: function () {
	      var _handleMessage2 = _asyncToGenerator( regeneratorRuntime.mark(function _callee2(message) {
	        var type;
