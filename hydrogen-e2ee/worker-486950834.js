(function () {
	...
	*/
	...
	var FORCED$2 = NEGATIVE_ZERO || !STRICT_METHOD || !USES_TO_LENGTH;
	  ...
	  _createClass(MessageHandler, [{
	    ...
	    value: function _megolmDecrypt(sessionKey, ciphertext) {
	      ...
	      return this._toMessage(function () {
	        ...
	        try {
	          session = new _this2._olm.InboundGroupSession();
	          ...
	          (_session = session) === null || _session === void 0 ? void 0 : _session.free();
	        }
	      });
	    }
	  }, {
